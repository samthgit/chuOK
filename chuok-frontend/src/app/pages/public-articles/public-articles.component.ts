...
// Component for displaying a set of public articles and handling user navigation.
// Shows a single article at a time and displays a sign-up prompt if the user is not logged in.
@Component({
...
export class PublicArticlesComponent implements OnInit {
  // List of public articles to display
  articles = [
  ...
  // The ID of the currently displayed article
  ...
  /**
   * On component initialization, subscribes to route changes and updates the current article.
   */
  ngOnInit(): void {
